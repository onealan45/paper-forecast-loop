# PR71 Lineage Run Log Blocked Reason Copy Review
...
- `README.md`
- `docs/PRD.md`
- `docs/architecture/PR71-lineage-run-log-blocked-reason-copy.md`

## Change Summary

Dashboard and operator console now render the lineage blocked-reason value
`cross_sample_autopilot_run_missing` as:

`缺少 cross-sample autopilot run (cross_sample_autopilot_run_missing)`

The raw reason code remains visible for traceability. The underlying
`AutomationRun.steps` artifact value is unchanged.
