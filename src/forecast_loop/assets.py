...
ASSET_REGISTRY: tuple[Asset, ...] = (
    ...
    Asset(
        ...
        status="planned",
        default_provider="csv-fixture",
        data_status="fixture_provider_available",
        notes="M3D supports CSV fixture import with US market calendar and adjusted close handling.",
    ),
    Asset(
        symbol="QQQ",
